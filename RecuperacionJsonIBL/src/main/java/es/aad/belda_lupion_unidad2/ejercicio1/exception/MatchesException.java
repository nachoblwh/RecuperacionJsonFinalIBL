package es.aad.belda_lupion_unidad2.ejercicio1.exception;
...
public class MatchesException extends Exception
{
	...
	{
		this(MatchesException.DEFAULT_ERROR_CODE, MatchesException.DEFAULT_ERROR_MESSAGE);
	}

	/**
	 * Constructor by default with exception
	 */
	public MatchesException(Exception exception)
	{
		this(MatchesException.DEFAULT_ERROR_CODE, MatchesException.DEFAULT_ERROR_MESSAGE, exception);
	}
	 ...
	 */
	public MatchesException(String code, String message)
	{
		super(message);
	 ...
	 */
	public MatchesException(String code, String message, Exception exception)
	{
