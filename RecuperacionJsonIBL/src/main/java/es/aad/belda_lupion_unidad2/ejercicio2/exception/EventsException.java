package es.aad.belda_lupion_unidad2.ejercicio2.exception;
...
public class EventsException extends Exception
{
	...
	{
		this(EventsException.DEFAULT_ERROR_CODE, EventsException.DEFAULT_ERROR_MESSAGE);
	}

	/**
	 * Constructor by default with exception
	 */
	public EventsException(Exception exception)
	{
		this(EventsException.DEFAULT_ERROR_CODE, EventsException.DEFAULT_ERROR_MESSAGE, exception);
	}
	 ...
	 */
	public EventsException(String code, String message)
	{
		super(message);
	 ...
	 */
	public EventsException(String code, String message, Exception exception)
	{
